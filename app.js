    ...
    if (platform[i].checked) {
      ...
      fetch(
          ...
          platform[i].value,
        {
          ...
          headers: {
            "x-rapidapi-key":
              "ca80e9e0bemsh20dfbedd9e3a1e4p18ba1bjsn961ab30b9aa8",
            ...
            if ((i = 2)) {
              ...
              output.append(
                playerStatBr(
                  ...
                  data.br_dmz.wins,
                  data.br_dmz.topFive,
                  data.br_dmz.timePlayed,
                  data.br_dmz.gamesPlayed,
                  data.br_dmz.contracts
                )
              );
            }
            if ((i = 3)) {
              ...
              output.append(
                playerStatBr(
                  ...
                  data.br_all.wins,
                  data.br_all.topFive,
                  data.br_all.timePlayed,
                  data.br_all.gamesPlayed,
                  data.br_all.contracts
                )
              );
            }
          }
...
function playerStatBr(
  ...
  playerPlayTimeStat.innerText =
    "Playtime: " + Math.round(timePlayed / 60 / 60) + " h";
